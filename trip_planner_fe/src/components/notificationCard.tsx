  ...
  return (
    <div className="notification-wrapper">
      {notifications.map((notification) => (
        ...
        >
          <svg
            className={`notification-card-wave-${notification.type}`}
          ...
          <div
            className={`notification-card-icon-container-${notification.type}`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
            ...
            >
              <path
                fill={notification.type === "error" ? "red" : "green"}
                d={
          ...
          <div className="notification-card-message-text-container">
            <p
              className={`notification-card-message-text-${notification.type}`}
            >
              {notification.type === "error" ? "Fehler" : "Hinweis"}
            </p>
            <p className="notification-card-sub-text">{notification.message}</p>
          </div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 15 15"
            ...
            fill="none"
            stroke="currentColor"
            className="notification-card-cross-icon"
